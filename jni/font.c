...
#define DECLARE_FONT(name, w, h) \
static const struct font_t font_##name = { \
	.width = w, \
	.height = h, \
	.count = sizeof(font_##name##_data) / FONT_WIDTH_BYTES(w) / (h), \
	.data = font_##name##_data \
}

static const uint8_t font_8x16_data[4096] = {
